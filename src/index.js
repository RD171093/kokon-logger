...
// Intercept MESSAGE_DELETE and store deleted messages
patches.push(before("dispatch", FluxDispatcher, ([event]) => {
  if (event.type === "MESSAGE_DELETE") {
    ...
    // Save deleted messages locally
    storage.deletedMessages = storage.deletedMessages || {};
...
// Modify UI to show "deleted" messages with a highlight
...
// Unload function to clean up patches
